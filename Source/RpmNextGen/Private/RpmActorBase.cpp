...
// Called every frame
void ARpmActorBase::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void ARpmActorBase::ReceiveOnStaticMeshComponentCreated_Implementation(UStaticMeshComponent* StaticMeshComponent, const FglTFRuntimeNode& Node)
{

}

void ARpmActorBase::ReceiveOnSkeletalMeshComponentCreated_Implementation(USkeletalMeshComponent* SkeletalMeshComponent, const FglTFRuntimeNode& Node)
{
	
}

void ARpmActorBase::PostUnregisterAllComponents()
{
	if (Asset)
	{
		Asset->ClearCache();
